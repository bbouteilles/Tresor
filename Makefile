...
# translation
SOURCES = tresor.py ui_tresor.py __init__.py tresordialog.py
#TRANSLATIONS = i18n/tresor_en.ts
TRANSLATIONS =
...
PY_FILES = tresor.py tresordialog.py __init__.py

EXTRAS = icon.png metadata.txt

UI_FILES = ui_tresor.py
